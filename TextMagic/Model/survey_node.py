...
class SurveyNode(object):
    ...
    def is_end_node(self, is_end_node):
        ...
        :type: bool
        """
        if is_end_node is None:
            raise ValueError("Invalid value for `is_end_node`, must not be `None`")  # noqa: E501
    ...
    def send_delay(self, send_delay):
        ...
        if send_delay is None:
            raise ValueError("Invalid value for `send_delay`, must not be `None`")  # noqa: E501
    ...
    def end_nodes(self, end_nodes):
        ...
        if end_nodes is None:
            raise ValueError("Invalid value for `end_nodes`, must not be `None`")  # noqa: E501
