...
from TextMagic.Model.country import Country  # noqa: F401,E501
from TextMagic.Model.currency import Currency  # noqa: F401,E501
from TextMagic.Model.timezone import Timezone  # noqa: F401,E501
from TextMagic.Model.user_image import UserImage  # noqa: F401,E501
...
class SubaccountWithToken(object):
    ...
    def subaccount_type(self, subaccount_type):
        ...
        :type: str
        """
        if subaccount_type is None:
            raise ValueError("Invalid value for `subaccount_type`, must not be `None`")  # noqa: E501
    ...
    def email_accepted(self, email_accepted):
        ...
        :type: bool
        """
        if email_accepted is None:
            raise ValueError("Invalid value for `email_accepted`, must not be `None`")  # noqa: E501
    ...
    def phone_accepted(self, phone_accepted):
        ...
        :type: bool
        """
        if phone_accepted is None:
            raise ValueError("Invalid value for `phone_accepted`, must not be `None`")  # noqa: E501
