...
class DoEmailLookupResponse(object):
    ...
    def email_role(self, email_role):
        ...
        :type: str
        """
        if email_role is None:
            raise ValueError("Invalid value for `email_role`, must not be `None`")  # noqa: E501
    ...
    def deliverability(self, deliverability):
        ...
        if deliverability is None:
            raise ValueError("Invalid value for `deliverability`, must not be `None`")  # noqa: E501
    ...
    def is_disposable_address(self, is_disposable_address):
        ...
        :type: bool
        """
        if is_disposable_address is None:
            raise ValueError("Invalid value for `is_disposable_address`, must not be `None`")  # noqa: E501
    ...
    def domain_part(self, domain_part):
        ...
        if domain_part is None:
            raise ValueError("Invalid value for `domain_part`, must not be `None`")  # noqa: E501
    ...
    def is_in_white_list(self, is_in_white_list):
        ...
        :type: bool
        """
        if is_in_white_list is None:
            raise ValueError("Invalid value for `is_in_white_list`, must not be `None`")  # noqa: E501
    ...
    def is_in_black_list(self, is_in_black_list):
        ...
        :type: bool
        """
        if is_in_black_list is None:
            raise ValueError("Invalid value for `is_in_black_list`, must not be `None`")  # noqa: E501
    ...
    def has_mx(self, has_mx):
        ...
        """
        if has_mx is None:
            raise ValueError("Invalid value for `has_mx`, must not be `None`")  # noqa: E501
    ...
    def has_aa(self, has_aa):
        ...
        """
        if has_aa is None:
            raise ValueError("Invalid value for `has_aa`, must not be `None`")  # noqa: E501
    ...
    def has_aaaa(self, has_aaaa):
        ...
        """
        if has_aaaa is None:
            raise ValueError("Invalid value for `has_aaaa`, must not be `None`")  # noqa: E501
