...
class UpdateChatDesktopNotificationSettingsInputObject(object):
    ...
    def play_sound(self, play_sound):
        ...
        if play_sound is None:
            raise ValueError("Invalid value for `play_sound`, must not be `None`")  # noqa: E501
    ...
    def show_notifications(self, show_notifications):
        ...
        if show_notifications is None:
            raise ValueError("Invalid value for `show_notifications`, must not be `None`")  # noqa: E501
