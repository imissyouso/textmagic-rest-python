...
class Chat(object):
    ...
    def original_id(self, original_id):
        ...
        if original_id is None:
            raise ValueError("Invalid value for `original_id`, must not be `None`")  # noqa: E501
    ...
    def unsubscribed_contact_id(self, unsubscribed_contact_id):
        ...
        :type: int
        """
        if unsubscribed_contact_id is None:
            raise ValueError("Invalid value for `unsubscribed_contact_id`, must not be `None`")  # noqa: E501
    ...
    def muted_until(self, muted_until):
        ...
        if muted_until is None:
            raise ValueError("Invalid value for `muted_until`, must not be `None`")  # noqa: E501
    ...
    def time_left_mute(self, time_left_mute):
        ...
        :type: int
        """
        if time_left_mute is None:
            raise ValueError("Invalid value for `time_left_mute`, must not be `None`")  # noqa: E501
