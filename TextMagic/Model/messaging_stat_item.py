...
class MessagingStatItem(object):
    ...
    def reply_rate(self, reply_rate):
        ...
        if reply_rate is None:
            raise ValueError("Invalid value for `reply_rate`, must not be `None`")  # noqa: E501
    ...
    def delivery_rate(self, delivery_rate):
        ...
        if delivery_rate is None:
            raise ValueError("Invalid value for `delivery_rate`, must not be `None`")  # noqa: E501
    ...
    def messages_received(self, messages_received):
        ...
        if messages_received is None:
            raise ValueError("Invalid value for `messages_received`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_delivered(self, messages_sent_delivered):
        ...
        :type: int
        """
        if messages_sent_delivered is None:
            raise ValueError("Invalid value for `messages_sent_delivered`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_accepted(self, messages_sent_accepted):
        ...
        :type: int
        """
        if messages_sent_accepted is None:
            raise ValueError("Invalid value for `messages_sent_accepted`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_buffered(self, messages_sent_buffered):
        ...
        :type: int
        """
        if messages_sent_buffered is None:
            raise ValueError("Invalid value for `messages_sent_buffered`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_failed(self, messages_sent_failed):
        ...
        :type: int
        """
        if messages_sent_failed is None:
            raise ValueError("Invalid value for `messages_sent_failed`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_rejected(self, messages_sent_rejected):
        ...
        :type: int
        """
        if messages_sent_rejected is None:
            raise ValueError("Invalid value for `messages_sent_rejected`, must not be `None`")  # noqa: E501
    ...
    def messages_sent_parts(self, messages_sent_parts):
        ...
        :type: int
        """
        if messages_sent_parts is None:
            raise ValueError("Invalid value for `messages_sent_parts`, must not be `None`")  # noqa: E501
