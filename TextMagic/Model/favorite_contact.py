...
class FavoriteContact(object):
    ...
    def primary_label(self, primary_label):
        ...
        if primary_label is None:
            raise ValueError("Invalid value for `primary_label`, must not be `None`")  # noqa: E501
    ...
    def secondary_label(self, secondary_label):
        ...
        if secondary_label is None:
            raise ValueError("Invalid value for `secondary_label`, must not be `None`")  # noqa: E501
    ...
    def tertiary_label(self, tertiary_label):
        ...
        :type: str
        """
        if tertiary_label is None:
            raise ValueError("Invalid value for `tertiary_label`, must not be `None`")  # noqa: E501
