...
class MessageOut(object):
    ...
    def message_time(self, message_time):
        ...
        if message_time is None:
            raise ValueError("Invalid value for `message_time`, must not be `None`")  # noqa: E501
    ...
    def charset(self, charset):
        ...
        """
        if charset is None:
            raise ValueError("Invalid value for `charset`, must not be `None`")  # noqa: E501
    ...
    def charset_label(self, charset_label):
        ...
        if charset_label is None:
            raise ValueError("Invalid value for `charset_label`, must not be `None`")  # noqa: E501
    ...
    def parts_count(self, parts_count):
        ...
        if parts_count is None:
            raise ValueError("Invalid value for `parts_count`, must not be `None`")  # noqa: E501
