...
class GetStateResponse(object):
    ...
    def system_cache_clear(self, system_cache_clear):
        ...
        :type: int
        """
        if system_cache_clear is None:
            raise ValueError("Invalid value for `system_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def system_exit(self, system_exit):
        ...
        if system_exit is None:
            raise ValueError("Invalid value for `system_exit`, must not be `None`")  # noqa: E501
    ...
    def system_alert(self, system_alert):
        ...
        :type: int
        """
        if system_alert is None:
            raise ValueError("Invalid value for `system_alert`, must not be `None`")  # noqa: E501
    ...
    def system_account_state_changed(self, system_account_state_changed):
        ...
        :type: int
        """
        if system_account_state_changed is None:
            raise ValueError("Invalid value for `system_account_state_changed`, must not be `None`")  # noqa: E501
    ...
    def message_deleted(self, message_deleted):
        ...
        if message_deleted is None:
            raise ValueError("Invalid value for `message_deleted`, must not be `None`")  # noqa: E501
    ...
    def message_incoming(self, message_incoming):
        ...
        if message_incoming is None:
            raise ValueError("Invalid value for `message_incoming`, must not be `None`")  # noqa: E501
    ...
    def message_incoming_deleted(self, message_incoming_deleted):
        ...
        :type: int
        """
        if message_incoming_deleted is None:
            raise ValueError("Invalid value for `message_incoming_deleted`, must not be `None`")  # noqa: E501
    ...
    def message_state_changed(self, message_state_changed):
        ...
        :type: int
        """
        if message_state_changed is None:
            raise ValueError("Invalid value for `message_state_changed`, must not be `None`")  # noqa: E501
    ...
    def message_bulk_end(self, message_bulk_end):
        ...
        :type: int
        """
        if message_bulk_end is None:
            raise ValueError("Invalid value for `message_bulk_end`, must not be `None`")  # noqa: E501
    ...
    def message_wipe_end(self, message_wipe_end):
        ...
        :type: int
        """
        if message_wipe_end is None:
            raise ValueError("Invalid value for `message_wipe_end`, must not be `None`")  # noqa: E501
    ...
    def message_sent(self, message_sent):
        ...
        if message_sent is None:
            raise ValueError("Invalid value for `message_sent`, must not be `None`")  # noqa: E501
    ...
    def message_session_deleted(self, message_session_deleted):
        ...
        :type: int
        """
        if message_session_deleted is None:
            raise ValueError("Invalid value for `message_session_deleted`, must not be `None`")  # noqa: E501
    ...
    def message_cache_clear(self, message_cache_clear):
        ...
        :type: int
        """
        if message_cache_clear is None:
            raise ValueError("Invalid value for `message_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def message_incoming_cache_clear(self, message_incoming_cache_clear):
        ...
        :type: int
        """
        if message_incoming_cache_clear is None:
            raise ValueError("Invalid value for `message_incoming_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def message_schedule_added(self, message_schedule_added):
        ...
        :type: int
        """
        if message_schedule_added is None:
            raise ValueError("Invalid value for `message_schedule_added`, must not be `None`")  # noqa: E501
    ...
    def message_schedule_state_changed(self, message_schedule_state_changed):
        ...
        :type: int
        """
        if message_schedule_state_changed is None:
            raise ValueError("Invalid value for `message_schedule_state_changed`, must not be `None`")  # noqa: E501
    ...
    def message_schedule_deleted(self, message_schedule_deleted):
        ...
        :type: int
        """
        if message_schedule_deleted is None:
            raise ValueError("Invalid value for `message_schedule_deleted`, must not be `None`")  # noqa: E501
    ...
    def message_schedule_cache_clear(self, message_schedule_cache_clear):
        ...
        :type: int
        """
        if message_schedule_cache_clear is None:
            raise ValueError("Invalid value for `message_schedule_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def message_template_cache_clear(self, message_template_cache_clear):
        ...
        :type: int
        """
        if message_template_cache_clear is None:
            raise ValueError("Invalid value for `message_template_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def call_finished(self, call_finished):
        ...
        if call_finished is None:
            raise ValueError("Invalid value for `call_finished`, must not be `None`")  # noqa: E501
    ...
    def chat_created(self, chat_created):
        ...
        if chat_created is None:
            raise ValueError("Invalid value for `chat_created`, must not be `None`")  # noqa: E501
    ...
    def chat_marked_as_read(self, chat_marked_as_read):
        ...
        :type: int
        """
        if chat_marked_as_read is None:
            raise ValueError("Invalid value for `chat_marked_as_read`, must not be `None`")  # noqa: E501
    ...
    def chat_muted(self, chat_muted):
        ...
        :type: int
        """
        if chat_muted is None:
            raise ValueError("Invalid value for `chat_muted`, must not be `None`")  # noqa: E501
    ...
    def chat_unmuted(self, chat_unmuted):
        ...
        :type: int
        """
        if chat_unmuted is None:
            raise ValueError("Invalid value for `chat_unmuted`, must not be `None`")  # noqa: E501
    ...
    def chat_deleted(self, chat_deleted):
        ...
        :type: int
        """
        if chat_deleted is None:
            raise ValueError("Invalid value for `chat_deleted`, must not be `None`")  # noqa: E501
    ...
    def chat_closed(self, chat_closed):
        ...
        :type: int
        """
        if chat_closed is None:
            raise ValueError("Invalid value for `chat_closed`, must not be `None`")  # noqa: E501
    ...
    def chat_reopened(self, chat_reopened):
        ...
        :type: int
        """
        if chat_reopened is None:
            raise ValueError("Invalid value for `chat_reopened`, must not be `None`")  # noqa: E501
    ...
    def chat_cache_clear(self, chat_cache_clear):
        ...
        :type: int
        """
        if chat_cache_clear is None:
            raise ValueError("Invalid value for `chat_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def contact_added(self, contact_added):
        ...
        if contact_added is None:
            raise ValueError("Invalid value for `contact_added`, must not be `None`")  # noqa: E501
    ...
    def contact_deleted(self, contact_deleted):
        ...
        :type: int
        """
        if contact_deleted is None:
            raise ValueError("Invalid value for `contact_deleted`, must not be `None`")  # noqa: E501
    ...
    def contact_state_changed(self, contact_state_changed):
        ...
        :type: int
        """
        if contact_state_changed is None:
            raise ValueError("Invalid value for `contact_state_changed`, must not be `None`")  # noqa: E501
    ...
    def list_added(self, list_added):
        ...
        if list_added is None:
            raise ValueError("Invalid value for `list_added`, must not be `None`")  # noqa: E501
    ...
    def list_deleted(self, list_deleted):
        ...
        :type: int
        """
        if list_deleted is None:
            raise ValueError("Invalid value for `list_deleted`, must not be `None`")  # noqa: E501
    ...
    def list_state_changed(self, list_state_changed):
        ...
        :type: int
        """
        if list_state_changed is None:
            raise ValueError("Invalid value for `list_state_changed`, must not be `None`")  # noqa: E501
    ...
    def contact_wipe_end(self, contact_wipe_end):
        ...
        :type: int
        """
        if contact_wipe_end is None:
            raise ValueError("Invalid value for `contact_wipe_end`, must not be `None`")  # noqa: E501
    ...
    def contact_import_end(self, contact_import_end):
        ...
        :type: int
        """
        if contact_import_end is None:
            raise ValueError("Invalid value for `contact_import_end`, must not be `None`")  # noqa: E501
    ...
    def contact_cache_clear(self, contact_cache_clear):
        ...
        :type: int
        """
        if contact_cache_clear is None:
            raise ValueError("Invalid value for `contact_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def list_cache_clear(self, list_cache_clear):
        ...
        :type: int
        """
        if list_cache_clear is None:
            raise ValueError("Invalid value for `list_cache_clear`, must not be `None`")  # noqa: E501
    ...
    def custom_fields_cache_clear(self, custom_fields_cache_clear):
        ...
        :type: int
        """
        if custom_fields_cache_clear is None:
            raise ValueError("Invalid value for `custom_fields_cache_clear`, must not be `None`")  # noqa: E501
