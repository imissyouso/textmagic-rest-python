...
class Currency(object):
    ...
    def unicode_symbol(self, unicode_symbol):
        ...
        :type: str
        """
        if unicode_symbol is None:
            raise ValueError("Invalid value for `unicode_symbol`, must not be `None`")  # noqa: E501
    ...
    def html_symbol(self, html_symbol):
        ...
        if html_symbol is None:
            raise ValueError("Invalid value for `html_symbol`, must not be `None`")  # noqa: E501
