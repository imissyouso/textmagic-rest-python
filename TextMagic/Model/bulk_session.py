...
class BulkSession(object):
    ...
    def items_processed(self, items_processed):
        ...
        if items_processed is None:
            raise ValueError("Invalid value for `items_processed`, must not be `None`")  # noqa: E501
    ...
    def items_total(self, items_total):
        ...
        if items_total is None:
            raise ValueError("Invalid value for `items_total`, must not be `None`")  # noqa: E501
