...
from TextMagic.Model.do_auth_response_min_versions import DoAuthResponseMinVersions  # noqa: F401,E501
...
class DoAuthResponse(object):
    ...
    def min_versions(self, min_versions):
        ...
        if min_versions is None:
            raise ValueError("Invalid value for `min_versions`, must not be `None`")  # noqa: E501
    ...
    def disallowed_rules(self, disallowed_rules):
        ...
        :type: list[str]
        """
        if disallowed_rules is None:
            raise ValueError("Invalid value for `disallowed_rules`, must not be `None`")  # noqa: E501
