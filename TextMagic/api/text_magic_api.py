...
class TextMagicApi(object):
    ...
    def import_contacts(self, import_contacts_input_object, file, **kwargs):  # noqa: E501
        """Import contacts from the CSV, XLS or XLSX file.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_contacts(import_contacts_input_object, file, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.import_contacts_with_http_info(import_contacts_input_object, file, **kwargs)  # noqa: E501
        else:
            (data) = self.import_contacts_with_http_info(import_contacts_input_object, file, **kwargs)  # noqa: E501
            return data

    def import_contacts_with_http_info(self, import_contacts_input_object, file, **kwargs):  # noqa: E501
        """Import contacts from the CSV, XLS or XLSX file.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.import_contacts_with_http_info(import_contacts_input_object, file, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['import_contacts_input_object', 'file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
